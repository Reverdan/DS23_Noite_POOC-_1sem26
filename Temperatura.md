# ðŸŒ¡ï¸ Projeto Temperatura — Explicação Detalhada
...
## ðŸ§© Conceitos de Orientação a Objetos Aplicados
...
## ðŸ§± Princípios SOLID no Projeto

- **S — Responsabilidade Ãšnica:** Cada classe tem uma função clara (validação, conversão, controle).
